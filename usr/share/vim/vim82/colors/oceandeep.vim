...
highlight LineNr ctermbg=31
highlight LineNr ctermfg=159
highlight Cursor        gui=None guibg=PaleTurquoise3 guifg=#5fd7ff
...
""" Console
if v:version >= 700
    highlight PMenu      cterm=bold ctermbg=DarkGreen ctermfg=81
    highlight PMenuSel   cterm=bold ctermbg=Yellow ctermfg=81
...
highlight Normal        ctermfg=81 ctermbg=None
highlight Search        ctermfg=Black ctermbg=Red cterm=NONE
highlight Visual        cterm=reverse
highlight Cursor        ctermfg=202 ctermbg=202 cterm=bold
highlight iCursor        ctermfg=202 ctermbg=202 cterm=bold
highlight Special       ctermfg=57
highlight Comment       ctermfg=DarkGray
highlight StatusLine    ctermfg=Blue ctermbg=39
